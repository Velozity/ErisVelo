...
class Client extends EventEmitter {
  ...
  getActiveThreads(channelID) {
    return this.requestHandler
      .request("GET", Endpoints.THREADS_ACTIVE(channelID), true)
      .then((response) => {
        return {
  ...
  getChannel(channelID) {
    ...
    return (
      this.privateChannels.get(channelID) || this.groupChannels.get(channelID)
    );
  }
  ...
  joinVoiceChannel(channelID, options = {}) {
    ...
    return this.voiceConnections.join(
      this.channelGuildMap[channelID] || "call",
      channelID,
      options
    );
  }
  ...
  searchChannelMessages(channelID, query) {
    return this.requestHandler
      .request("GET", Endpoints.CHANNEL_MESSAGES_SEARCH(channelID), true, {
